<script>
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${URL_REST}/api/demo/messaging/meta/whatsapp/send`, {
        method: "POST",
        headers: {
  ...
  <section class="card bg-base-100 shadow-sm border border-base-200">
    <div class="card-body space-y-4">
      ...
      <div class="flex items-center gap-3">
        ...
        <span class="text-xs text-neutral-500">POST /api/demo/messaging/meta/whatsapp/send</span>
      </div>

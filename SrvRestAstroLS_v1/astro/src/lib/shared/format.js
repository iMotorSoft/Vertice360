 ...
 * Derived from vertice360_workflow/time.js and Orquestador normalization logic.
 */
...
/**
 * Normalizes a client phone number for display (e.g. adds + if missing).
 * Origin: OrquestadorAppLive.svelte normalizeClienteDisplay
 */
export const normalizeClienteDisplay = (value) => {
...
export const DATE_TIME_FORMATTER = new Intl.DateTimeFormat("es-AR", {
    day: "2-digit",
    month: "2-digit",
    hour: "2-digit",
    minute: "2-digit",
